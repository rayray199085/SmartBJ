...
public class MyImagesGridViewAdapter extends BaseAdapter {
    private ArrayList<NewsImageDataChildren> mNews;
    private Context mContext;
    private LayoutInflater mInflater;

    public MyImagesGridViewAdapter(Context mContext, ArrayList<NewsImageDataChildren> mNews) {
        this.mNews = mNews;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.view_image_grid_view_item, null);
            viewHolder.imageView = convertView.findViewById(R.id.iv_news_images_grid_view_item_img);
            viewHolder.textView = convertView.findViewById(R.id.tv_news_images_grid_view_item_title);
